//2013-05-22 This file was last modified on January 22
...
void draw_beta_gamma() {
	...
	TH1I *h		= gDirectory->Get("h_bkgd_bg_LR");
	
	TF1 *fn	= new TF1("fn", fitf, 1270., 1320., 4);
	fn->SetParameters(2., 9.0, 1296., 1.2);
...
*/
	...
	h->Draw();
	h->GetXaxis()->SetRangeUser(1260,1340);
	fn->Draw("SAME");
