...
Double_t BFitNamespace::Y2 (Double_t *t, Double_t *a) {
	...
	using namespace TMath;
	static Int_t n, N;
	static Double_t tT1, tU1, tU2, tn, tN, An, AN, Bn, BN, cT1, cU1, cU2, amplitude, y20, y2, Y2, f, A, B;
...
Double_t BFitNamespace::Y3 (Double_t *t, Double_t *a) {
	...
	using namespace TMath;
	static Int_t n, N;
	static Double_t tT1, tT2, tU1, tU2, tU3, tn, tN, An, AN, Bn, BN, cT1, cU1, cU2, amplitude, y30, y3, Y3, f, A, B;
	static Double_t expT1n, expU1n, expU2n;
	static Double_t expT1N, expU1N, expU2N;
	extern Double_t iota, tCap, tBac, tCyc, t1, t2, t3;
//	bookGlobals();
