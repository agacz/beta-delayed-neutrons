...
EXTERNAL TH1I *h_tof_2dE_R_mcp;
EXTERNAL TH1I *h_tof_2dE_T_mcp;
EXTERNAL TH1I *h_tof_2dE_mcp;
...
EXTERNAL TH1I *h_En_137Te_subtract;
EXTERNAL TH1I *h_En_137Te_subtract_LT;
EXTERNAL TH1I *h_En_137Te_subtract_LR;
EXTERNAL TH1I *h_En_137Te_subtract_BT;
EXTERNAL TH1I *h_En_137Te_subtract_BR;
// MCP maps
...
EXTERNAL TH1D *h_LT_fast_vs_cycle_time_observed;
EXTERNAL TH1D *h_LR_fast_vs_cycle_time_observed;
EXTERNAL TH1D *h_BT_fast_vs_cycle_time_observed;
EXTERNAL TH1D *h_BR_fast_vs_cycle_time_observed;
...
EXTERNAL TH1D *h_LT_slow_vs_cycle_time_observed;
EXTERNAL TH1D *h_LR_slow_vs_cycle_time_observed;
EXTERNAL TH1D *h_BT_slow_vs_cycle_time_observed;
EXTERNAL TH1D *h_BR_slow_vs_cycle_time_observed;
...
EXTERNAL TH1D *h_LT_oops_vs_cycle_time_observed;
EXTERNAL TH1D *h_LR_oops_vs_cycle_time_observed;
EXTERNAL TH1D *h_BT_oops_vs_cycle_time_observed;
EXTERNAL TH1D *h_BR_oops_vs_cycle_time_observed;
